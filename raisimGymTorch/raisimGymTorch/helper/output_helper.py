...
class EvaluationVisualizer:
    ...
    def visualize(self):
        ...
        plt.plot(self.action_lin_corr_all[:, 0] + self.ref_pos_W_all[:, 0], 'r*', label='ref_corr_pos_W_all_x')
        plt.plot(self.action_lin_corr_all[:, 1] + self.ref_pos_W_all[:, 1], 'g*', label='ref_corr_pos_W_all_y')
        plt.plot(self.action_lin_corr_all[:, 2] + self.ref_pos_W_all[:, 2], 'b*', label='ref_corr_pos_W_all_z')
        plt.legend()
        ...
        plt.plot(self.action_orient_corr_all[:, 0] + self.ref_orient_quat_W_all[:, 0], 'r*', label='ref_orient_corr_quat_W_all_x')
        plt.plot(self.action_orient_corr_all[:, 1] + self.ref_orient_quat_W_all[:, 1], 'g*', label='ref_orient_corr_quat_W_all_y')
        plt.plot(self.action_orient_corr_all[:, 2] + self.ref_orient_quat_W_all[:, 2], 'b*', label='ref_orient_corr_quat_W_all_z')
        plt.plot(self.action_orient_corr_all[:, 3] + self.ref_orient_quat_W_all[:, 3], 'm*', label='ref_orient_corr_quat_W_all_w')
        plt.legend()
