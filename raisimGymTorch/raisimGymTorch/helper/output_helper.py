...
class EvaluationVisualizer:
    ...
    def visualize(self):
        ...
        plt.plot(corr_ref_W_all_quat[:, 0], 'r*', label='ref_orient_corr_quat_W_all_x')
        plt.plot(corr_ref_W_all_quat[:, 1], 'g*', label='ref_orient_corr_quat_W_all_y')
        plt.plot(corr_ref_W_all_quat[:, 2], 'b*', label='ref_orient_corr_quat_W_all_z')
